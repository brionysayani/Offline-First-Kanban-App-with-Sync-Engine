  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col justify-center px-6 py-16">
      <div className="rounded-2xl border border-slate-800 bg-slate-900 p-8 shadow-xl">
        ...
        <p className="mt-2 text-sm text-slate-400">A placeholder registration screen for the initial scaffold.</p>

        <div className="mt-8 space-y-3">
          <input className="w-full rounded-lg border border-slate-700 bg-slate-950 px-4 py-3" placeholder="Name" />
          ...
          <button className="w-full rounded-lg bg-cyan-500 px-4 py-3 font-medium text-slate-950">Register</button>
        </div>
